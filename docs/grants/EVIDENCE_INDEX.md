...
| Landing source and build | Engineering | `apps/landing` | Demonstrated; local build passed | 12 Aug 2026 | Public product preview | Preview/production URL and SHA |
...
| Landing quality summary | Engineering | type-check, lint, build | Passed locally | 12 Aug 2026 | Public-site quality | Browser/Lighthouse/preview evidence |
...
| Deployment evidence | Engineering | Vercel/GitHub | Missing for this branch | — | Release readiness | URLs, project roots, SHAs and smoke results |
