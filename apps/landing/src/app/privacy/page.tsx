...
export const metadata = {
  ...
  description: 'Privacy Policy for XeroWA AI.',
};
    ...
    <main className="min-h-screen bg-[#f6f7f3] px-5 py-12 text-[#101916] sm:py-20">
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-[#dce3df] bg-white p-6 shadow-sm sm:p-10">
        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-[#52605a]">
          <section>
            <h2 className="text-xl font-semibold text-[#101916]">What XeroWA AI processes</h2>
            <p className="mt-2">XeroWA AI helps a business send configured WhatsApp replies, capture leads, organise conversations, coordinate appointments, and identify chats that need human attention.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="mt-2">Customers can request access, correction, or deletion through the business they contacted. Business owners can contact XeroWA AI for support with a valid request.</p>
          </section>
          <section>
