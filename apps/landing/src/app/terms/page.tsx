...
export const metadata = {
  ...
  description: 'Terms for using XeroWA AI.',
};
    ...
    <main className="min-h-screen bg-[#f6f7f3] px-5 py-12 text-[#101916] sm:py-20">
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-[#dce3df] bg-white p-6 shadow-sm sm:p-10">
        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-[#52605a]">
          <section><h2 className="text-xl font-semibold text-[#101916]">Service</h2><p className="mt-2">XeroWA AI helps businesses configure approved WhatsApp replies, capture leads, share supported media, track conversations, and coordinate appointments or human handoffs.</p></section>
          <section><h2 className="text-xl font-semibold text-[#101916]">Business responsibility</h2><p className="mt-2">The business owner is responsible for the accuracy, legality, and currency of all configured replies, media, offers, and customer communication. XeroWA AI does not provide legal, medical, or financial advice.</p></section>
          <section><h2 className="text-xl font-semibold text-[#101916]">WhatsApp and Meta</h2><p className="mt-2">Use of WhatsApp Cloud API remains subject to Meta’s terms, messaging policies, template rules, and conversation charges. Meta services may change independently of XeroWA AI.</p></section>
